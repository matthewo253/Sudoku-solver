...
public class Sudoku {    
    ...
    private boolean [][]colHaveVal;
    private boolean [][]rowHaveVal;
    ...
    public Sudoku() {
        ...
        this.colHaveVal = new boolean[9][10];
        this.rowHaveVal = new boolean[9][10];
    }
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.colHaveVal[col][val] = true;
        this.rowHaveVal[row][val] = true;
    }
    ...
    public void removeVal(int val, int row, int col) {
        ...
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
        this.colHaveVal[col][val] = false;
        this.rowHaveVal[row][val] = false;
    }  
    ...
    private boolean isSafe(int val, int row, int col){
        if(!(rowHaveVal[row][val])){
            if(!(colHaveVal[col][val])){
                if(!(subgridHasVal[row/3][col/3][val])){
                    return true;
                }
            }
        }
